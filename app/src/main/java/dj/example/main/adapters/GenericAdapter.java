...
public class GenericAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements GenericAdapterInterface {
    ...
    public static final int BANNER = IDUtils.generateViewId();
    public static final int SPLIT_BANNER = IDUtils.generateViewId();
    ...
    class HeaderThumbnailViewHolder extends BaseItemHolder implements View.OnClickListener {
        ...
        private RecyclerView.LayoutManager getLayoutManager(){
            ...
            if (viewType == HORIZONTAL_FREE_SCROLL)
                return new LinearLayoutManager(itemView.getContext(), LinearLayoutManager.HORIZONTAL, false);
            if (viewType == SPLIT_BANNER)
                return new GridLayoutManager(itemView.getContext(), 2, LinearLayoutManager.VERTICAL, false);
            if (viewType == BANNER)
                return new GridLayoutManager(itemView.getContext(), 1, LinearLayoutManager.HORIZONTAL, false);
