...
public class HeaderThumbnailData implements Parcelable{
    ...
    public HeaderThumbnailData(String headerTitle, List<ThumbnailData> dataList, int viewType) {
        this.headerTitle = headerTitle;
        this.dataList = dataList;
    ...
    public static class ThumbnailData implements Parcelable {
        ...
        public ThumbnailData(int viewType, String thumbnailUrl, String title, String title1, String title2) {
            this.viewType = viewType;
            this.thumbnailUrl = thumbnailUrl;
            this.title = title;
            this.title1 = title1;
        ...
        public ThumbnailData(int viewType, String thumbnailUrl) {
            this.viewType = viewType;
            this.thumbnailUrl = thumbnailUrl;
        }
