...
import dj.example.main.presenter.GenericPresenterInterface;
...
public abstract class BaseActivity extends AppCoreActivity implements GenericPresenterInterface {
    ...
    @Override
    public void onSuccessAPICall(Object object) {
